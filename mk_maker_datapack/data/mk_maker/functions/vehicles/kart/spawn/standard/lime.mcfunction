summon armor_stand ~ ~ ~ {Silent:1b,Marker:1b,Invisible:1b,Small:1b,Invulnerable:1b,NoGravity:1b,Tags:["vehicle","kart","vehicle_init","standard"],DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:saddle",Count:1b,tag:{CustomModelData:41}}],CustomName:'{"text":"Lime Standard","italic":false}'}
