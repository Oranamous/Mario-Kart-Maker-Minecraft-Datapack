summon armor_stand ~ ~ ~ {Silent:1b,Marker:1b,Invisible:1b,Small:1b,Invulnerable:1b,NoGravity:1b,Tags:["vehicle","kart","vehicle_init"],DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:poisonous_potato",Count:1b,tag:{CustomModelData:3}}],CustomName:'{"text":"Kart","italic":false}'}
